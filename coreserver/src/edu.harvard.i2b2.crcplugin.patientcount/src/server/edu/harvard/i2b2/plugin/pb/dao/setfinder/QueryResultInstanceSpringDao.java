...
import edu.harvard.i2b2.plugin.pb.datavo.StatusEnum;

/**
 * This is class handles persistance of result instance and its update operation
 * $Id: QueryResultInstanceSpringDao.java,v 1.1 2010/02/11 22:56:44 rk903 Exp $
 * 
 * @author rkuttan
 */
	...
	public int getResultInstanceCountBySetSize(String userId, int compareDays,
		...
		if (dataSourceLookup.getServerType().equalsIgnoreCase(
			...
			queryCountSql = " select count(r1.result_instance_id) result_count,r1.real_set_size "
					...
					+ " qt_query_instance qi "
					+ " where "
					+ " (r1.start_date, r1.start_date) overlaps (CURRENT_TIMESTAMP - interval'"
					+ betweenDayValue + " days',"
					+ " CURRENT_TIMESTAMP - interval '"
					+ betweenDayValue + " days') "
					+ " and (r2.start_date, r2.start_date) overlaps (CURRENT_TIMESTAMP - interval'"
					+ betweenDayValue + " days',"
					+ " CURRENT_TIMESTAMP - interval '"
					+ betweenDayValue + " days')"
					+ " and r1.result_type_id = r2.result_type_id "
