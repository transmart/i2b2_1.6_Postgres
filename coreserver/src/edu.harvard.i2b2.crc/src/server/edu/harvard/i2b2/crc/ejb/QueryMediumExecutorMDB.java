 ...
 * @author rkuttan
 * 
 * @ejb.bean name="querytool.QueryExecutorMediumMDB" 
 * 		 display-name="QueryTool Executor Medium MDB" 
 * 		description="QueryTool Executor Medium"
 *           destination-type="javax.jms.Queue"
 *           destination-jndi-name="jms.querytool.QueryExecutorMedium"
 *           subscription-durability="Durable" 
 *           transaction-type="Bean"
 *           jndi-name="ejb.querytool.QueryExecutorMDBMedium"
 *           local-jndi-name="ejb.querytool.QueryExecutorMDBMediumLocal"
 *           view-type="both"
 *          
 *          
 * 
 ...
 *   
 */
public class QueryMediumExecutorMDB implements MessageDrivenBean, MessageListener {

	

	private MessageDrivenContext sessionContext;

	private static Log log = LogFactory.getLog(QueryMediumExecutorMDB.class);
	...
	public void onMessage(Message msg) {
		...
		try {
			log.info("Executing from Medium queue for query instance [ " + message.getString(QueryManagerBeanUtil.QUERY_INSTANCE_ID_PARAM) +" ]");
