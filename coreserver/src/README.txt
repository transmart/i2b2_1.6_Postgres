...
2. deploy Pm module
  ...
  Edit etc/jboss/pm-ds.xml to reflect your postgreSQL install
    ...
    Note: the default names in this file are those generated by the DB build scripts
...
3. deploy Ontology module
  ...
  Edit etc/jboss/ont-ds.xml and configure your data sources
    you may have to modify: connection-url, user-name, and password (there are three locations)
    changes may be necessary for: i2b2hive, i2b2metadata, and i2b2metadata2
    Note: the default names/pw in this file are those generated by the DB build scripts
  Edit etc/spring/OntologyApplicationContext.xml
    you may have to modify: driverClassName, url, username, password
    Note: the default names/pw in this file are those generated by the DB build scripts    
...
4. deploy CRC module
  ...
  Edit the build.properties file
	...
	jboss.home=YOUR_JBOSS_HOME_DIR
	axis2.war.name=i2b2.war
  Edit etc/spring/CRCLoaderApplicationContext.xml
    you may have to modify: driverClassName, url, username, password (two locations)
    Note: the default names/pw in this file are those generated by the DB build scripts    
  ...
  Edit the build.properties file
  	...
  	jboss.home=YOUR_JBOSS_HOME_DIR
  Edit etc/spring/PatientCountApplicationContext.xml
    you may have to modify: driverClassName, url, username, password (two locations)
    Note: the default names/pw in this file are those generated by the DB build scripts    
  ...
  Edit the build.properties file
	...
	jboss.home=YOUR_JBOSS_HOME_DIR
	axis2.war.name=i2b2.war
  Edit etc/jboss/crc-ds.xml
    you may have to modify: connection-url, user-name, and password
    Note: the default names/pw in this file are those generated by the DB build scripts
  Edit etc/jboss/crc-jms-ds.xml
    you may have to modify: connection-url, user-name, and password
    Note: the default names/pw in this file are those generated by the DB build scripts
...
5. deploy Workplace module
  ...
  Edit the build.properties file
	...
	jboss.home=YOUR_JBOSS_HOME_DIR
	axis2.war.name=i2b2.war
  Edit etc/jboss/work-ds.xml
    you may have to modify: connection-url, user-name, and password (two locations)
    Note: the default names/pw in this file are those generated by the DB build scripts
...
SUMMARY: these all the files that may need modification
...
./edu.harvard.i2b2.ontology/etc/spring/OntologyApplicationContext.xml
...
./edu.harvard.i2b2.crc.loader/etc/spring/CRCLoaderApplicationContext.xml
...
./edu.harvard.i2b2.crcplugin.patientcount/etc/spring/PatientCountApplicationContext.xml
...
./edu.harvard.i2b2.crc/etc/jboss/crc-ds.xml
./edu.harvard.i2b2.crc/etc/jboss/crc-jms-ds.xml
./edu.harvard.i2b2.crc/etc/spring/CRCApplicationContext.xml
./edu.harvard.i2b2.crc/etc/spring/crc_application_directory.properties

./edu.harvard.i2b2.workplace/build.properties
./edu.harvard.i2b2.workplace/etc/jboss/work-ds.xml
