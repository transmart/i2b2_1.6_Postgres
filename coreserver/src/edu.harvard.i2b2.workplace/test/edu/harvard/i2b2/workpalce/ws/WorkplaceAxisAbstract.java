 ...
 * @author rkuttan
 */
public abstract class WorkplaceAxisAbstract {
...
public static MessageHeaderType generateMessageHeader() {
	...
	edu.harvard.i2b2.workplace.datavo.i2b2message.ApplicationType appType = new edu.harvard.i2b2.workplace.datavo.i2b2message.ApplicationType();
