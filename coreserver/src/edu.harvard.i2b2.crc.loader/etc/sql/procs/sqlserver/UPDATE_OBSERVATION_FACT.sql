...
( PARTITION BY encounter_id,encounter_id_source,patient_id,patient_id_source,
  concept_cd,start_date,modifier_cd,provider_id ORDER BY encounter_id,encounter_id_source ) AS RNUM FROM ' + @upload_temptable_name +') 
...
set @insertSql =  'INSERT  INTO observation_fact(encounter_num,concept_cd, patient_num,provider_id, start_date,modifier_cd,valtype_cd,tval_char,nval_num,valueflag_cd,
...
upload_id) 
SELECT encounter_num,concept_cd, patient_num,provider_id, start_date,modifier_cd,valtype_cd,tval_char,nval_num,valueflag_cd,
...
set @insertSql = 'insert into observation_fact(encounter_num,
	patient_num,concept_cd,provider_id,start_date,modifier_cd,valtype_cd,tval_char,
    ...
    ' select  temp.encounter_num, temp.patient_num,temp.concept_cd,temp.provider_id,temp.start_date,temp.modifier_cd,temp.valtype_cd,temp.tval_char,
