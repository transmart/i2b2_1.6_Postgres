--Assumption : Encounter key will be made unique by adding source_cd to encrypted encounter_ide.
CREATE OR REPLACE PROCEDURE MERGE_TEMP_OBSERVATION_FACT(upload_temptable_name VARCHAR)
IS
BEGIN

	execute immediate 'MERGE  INTO observation_fact obsfact
