...
public class CRCLoaderUtil {
	...
	public static final String APPLICATION_DIRECTORY_PROPERTIES_FILENAME = "crc_loader_application_directory.properties";

	/** application directory property name **/
	public static final String APPLICATIONDIR_PROPERTIES = "edu.harvard.i2b2.crc.loader.applicationdir";
