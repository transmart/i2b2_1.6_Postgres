...
exec sp_executesql @deleteDuplicateSql;
	...
	-- in patient_mapping table.
     set @insertSql = ' insert into encounter_mapping (encounter_ide,encounter_ide_source,encounter_num,patient_ide,patient_ide_source,encounter_ide_status, upload_id)
